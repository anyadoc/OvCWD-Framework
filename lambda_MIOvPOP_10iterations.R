...
data_0 <- add_column(data, Year = rep(c(1:25), 10))  # number of years per iteration 26, model iterations 10 #tibble
data_1 <- add_column(data_0, Iteration = rep(c(1:10), each = 25))
