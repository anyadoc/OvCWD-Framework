...
new_data <- add_column(model_data, year = rep(c(1:25), params$iterations))  # number of years per iteration 26, model iterations 100 #tibble
...
iteration <- c(1:params$iterations)
